...
import { registerApi } from "../../APIServices/User/UserApi";
import AlertMessage from "../Alert/AlertMessage";
import { RegisterUserValidationSchema } from "../../utils/YubValidation";
...
const { error, isError, isPending, isSuccess, data} = userMutation
 console.log(data)  
      ...
      <div className="w-full  p-4">
        <div className="flex flex-col justify-center py-24 max-w-md mx-auto h-full">
          <form onSubmit={formik.handleSubmit}>
            ...
            <button
              className="h-14 mt-4 inline-flex items-center justify-center py-4 px-6 text-white font-bold font-heading rounded-full bg-orange-500 w-full text-center border border-orange-600 shadow hover:bg-orange-600 focus:ring focus:ring-orange-200 transition duration-200 mb-8"
              type="submit"
            >
              Sign Up
            </button>
